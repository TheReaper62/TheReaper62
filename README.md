...
Automated generation of digital invitation cards and programmed mass email.

Integrated system with Apple Shortcuts with real-time registration functionalities.

#### GSPreadPlus@pypi(2021 - Present)

Turn your Google Sheet straight into a queryable database using python. 

#### Subapy@pypi(2022 - Present)

A Wrapper for the Supbase API, supports CRUD functions and can be used sync/asynchronously. Supports PostgreSQL filtering and advanced querying.

#### ltadatamall@pypi(2022)

A Wrapper for the LTA Datamall API Get Bus Timings, Cab Information and Traffic Related Incidents
